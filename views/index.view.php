...
<div class="hero-video fixed select-none bg-black">
    <div class="swiper">
        ...
        <div class="swiper-wrapper h-screen w-screen">
            <!-- Slides -->
            <?php for ($i = 0; $i < sizeof($heroSection); $i++) : ?>
                <div class="swiper-slide">
                    <video class="slider-video h-screen w-screen object-cover" alt="Meraki Capital Partners Story Video" autoplay muted loop playsinline poster="/assets/images/black.webp">
                        ...
                        <source src="<?= $heroSection[$i]['link'] ?>" type="video/mp4">
                        <source src="<?= str_replace('.mp4', '.webm', $heroSection[$i]['link']) ?>" type="video/webm">
                        <source src="<?= str_replace('.mp4', '.ogv', $heroSection[$i]['link']) ?>" type="video/ogg">
                    </video>
                    ...
                    <div class="title-container absolute top-[5vh] left-0 w-full h-screen z-10 flex flex-col items-center justify-center text-center">
                        <!-- Slider Main Title -->
                        <h1 class="title font-black text-[5vw] max-lg:text-[10vw] max-md:text-[9vw] leading-[5vw] text-white leading-2 max-lg:leading-[10vw] max-md:leading-10 tracking-tight"><?= $heroSection[$i]['title'] ?></h1>

                        <!-- Read More Link -->
                        <div class="mt-10 cursor-pointer">
                            <a href="<?= $heroSection[$i]['cta'] ?>"><div class="w-[7vw] h-[7vw] max-md:w-[25vw] max-md:h-[25vw] rounded-full bg-transparent border-2 border-white border-dashed mx-1 duration-1000 hover:motion-safe:animate-spin z-[2]"></div>
